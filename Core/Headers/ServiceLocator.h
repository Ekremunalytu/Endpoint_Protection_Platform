...
// Forward declaration of ScanManager
class ScanManager;
...
private:
    ...
    static std::shared_ptr<ScanManager> scanManager;
...
public:
    ...
    static void provide(std::shared_ptr<ScanManager> service);  // Declaration only
    ...
    static void provide(ScanManager* service);  // Declaration only
    ...
    static std::shared_ptr<ScanManager> getScanManagerPtr();  // Declaration only
    ...
    static ScanManager* getScanManager();  // Declaration only
};
